...
class Season extends \App\Entity\Season implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Season' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Season' . "\0" . 'number', '' . "\0" . 'App\\Entity\\Season' . "\0" . 'year', '' . "\0" . 'App\\Entity\\Season' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Season' . "\0" . 'episodes', '' . "\0" . 'App\\Entity\\Season' . "\0" . 'programId'];
        }
     ...
     * {@inheritDoc}
     */
    public function getProgramId(): ?\App\Entity\Program
    {
     ...
     * {@inheritDoc}
     */
    public function setProgramId(?\App\Entity\Program $programId): \App\Entity\Season
    {
